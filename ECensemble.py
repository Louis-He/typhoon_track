...
url = "http://ftp.emc.ncep.noaa.gov/gc_wmb/jpeng/eemn/" + time + "/trak.eemn.atcfunix." + time  #EC
print("REQUESTING..." + url)
html = str(getHtml(url), encoding = "utf-8")

url = "http://ftp.emc.ncep.noaa.gov/gc_wmb/jpeng/eemn/" + time + "/trak.emx.atcfunix." + time  #EC
print("REQUESTING..." + url)
...
for i in range(1,25):
    if i < 10:
        ...
        member = str(i)
    url = "http://ftp.emc.ncep.noaa.gov/gc_wmb/jpeng/eemn/" + time + "/trak.en"+ member +".atcfunix." + time  # EC
    print("REQUESTING..." + url)
    html = html + str(getHtml(url), encoding="utf-8")
...
for i in range(len(lons)-1):
    ...
    if(sea[i]=="WP" and members[i]=="EEMN"):
